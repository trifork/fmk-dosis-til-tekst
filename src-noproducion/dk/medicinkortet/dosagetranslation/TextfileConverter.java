...
public class TextfileConverter {
	 ...
	 */
	public static String PATH_TO_INPUT_FILE = "2016-07-18/input_merged_added.txt";

	/**
	 * Path to output dir, where json files are written 
	 */
	public static String PATH_TO_OUTPUT_DIR = "2016-07-18/out";
	 ...
	 */
	public static final long RELEASE_NUMBER = 29L;
	
	/**
	 * Relase date for the data set, typically tomorrow
	 */
	public static final String RELEASE_DATE = "2016-07-18" ;
